...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      ...
      <h1  class="title top-title">Kotlin site!</h1>
	  <p > 
      <strong>Kotlin</strong> e статично-типизиран програмен език, който върви на Java виртуална машина и може да бъде компилиран заедно с JavaScript source code или да използва компилатор с LLVM* структура. Името идва от о-в Котлин, финския залив, в близост до Кронщад.
      Докато синтаксиса на Kotlin не е съвместим с Java, <strong>Kotlin</strong> e проектиран да взаимодейства с Java код и е зависим от Java кода в съществуващите Java Class Library, като например collections framework-a. Тази двойственост е целенасочено залегнала в разработката на Kotlin, като позволява на компаниите и отделните разработчици постепенна миграция от Java към Kotlin.</p>
      <p >
    ...
    Инструменти, които боравят с <strong>Kotlin</strong>
    ...
    - И разбира се Android Studio.
	  ...
	  <div id="comments">
        <h2 class= "comments">Коментари</h2>
        <ul >
          <li>
            <article>
              <header>
