...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <div id="pageintro" class="hoc clear"> 
    <article>
      ...
      <footer id="top-footer"><a href="#" ">Прочети повече &raquo;</a></footer>
    </article>
  </div>
</div>
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="art-txt">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="art-txt" ">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="art-txt" >Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace no" >&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="demo"></a>
        ...
        <hr>
        <p class="art-txt">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
        <p class="nospace"><a href="#">Read More &raquo;</a></p>
      </article>
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="demo"></a>
        <h4 class="nospace btmspace-10 font-x1 uppercase">Езикът C# и платформата .NET</h4>
        <ul class="nospace btmspace-10 group font-xs">
          <li class="fl_left">
        ...
        <hr>
        <p class="art-txt">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="art-txt">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
